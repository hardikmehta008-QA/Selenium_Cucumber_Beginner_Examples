...
@CucumberOptions(
        features = "E:\\Intellij_IDEA_Projects\\Selenium_Cucumber_Beginner_Examples\\src\\main\\java\\Features\\taggedhooks.feature", //the path of the feature file.
        ...
        dryRun = true, //to check the mapping is proper between feature file & step defination file.
